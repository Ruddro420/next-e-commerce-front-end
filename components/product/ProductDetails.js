          ...
          <>
              ...
              <div>
                <div className="rounded-lg border border-gray-300 bg-white">
                  <div className="relative aspect-[16/9] w-full overflow-hidden rounded-md bg-slate-100">
                    ...
                    {/* Wishlist button */}
                    <button className="absolute right-3 top-3 w-10 h-10 rounded-full bg-white/90 border border-dashed border-gray-300 flex items-center justify-center shadow-sm">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-4">
                    {thumbnails.slice(0, 2).map((src) => (
                      <button
                        ...
                        className={[
                          "rounded-md border border-gray-300 bg-white hover:shadow-sm transition",
                          mainImage === src ? "border-gray-300 " : "border-gray-300",
                        ].join(" ")}
                      >
                      ...
                      {variants.map((v) => {
                        ...
                        return (
                          <button
                            ...
                            className={[
                              "h-8 px-3 rounded border border-gray-300 text-sm font-semibold",
                              active
            ...
            <div className="mt-8 rounded-lg border border-gray-300 bg-white p-4">
              <div className="flex items-start gap-3">
                <div className="mt-0.5 h-7 w-7 rounded-full border border-gray-300 flex items-center justify-center text-slate-700">
                  i
                </div>
                <div>
